...
exports.loadCommonFunctions = ({ socket, webMessage }) => {
  const {
    args, commandName, fullArgs, fullMessage, isReply, prefix, remoteJid, replyJid, userJid,
  ...
  const sendWaitMessage = async (category = 'default') => {
    const waitMessage = getRandomWaitMessage(category);
